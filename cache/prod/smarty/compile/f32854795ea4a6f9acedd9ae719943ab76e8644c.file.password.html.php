<?php /* Smarty version Smarty-3.1.19-dev, created on 2016-04-03 09:39:04
         compiled from "/var/www/html/shopfacil/templates/frontOffice/default/password.html" */ ?>
<?php /*%%SmartyHeaderCode:199875712357010ee8a29300-05155628%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f32854795ea4a6f9acedd9ae719943ab76e8644c' => 
    array (
      0 => '/var/www/html/shopfacil/templates/frontOffice/default/password.html',
      1 => 1452088649,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '199875712357010ee8a29300-05155628',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57010ee96295a1_08288168',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57010ee96295a1_08288168')) {function content_57010ee96295a1_08288168($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/html/shopfacil/vendor/smarty/smarty/libs/plugins/modifier.truncate.php';
?><!doctype html>
<!--
...
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->processHookFunction(array('name'=>"password.stylesheet"),$_smarty_tpl);?>
...
" class="btn btn-default pull-left"><i class="fa fa-refresh"></i> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Send new password again"),$_smarty_tpl);?>
</a>
...
" class="btn btn-primary"><i class="fa fa-sign-in"></i> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Sign in"),$_smarty_tpl);?>
</a>
                </div>
            </div>
        <?php } else { ?>
...
" class="form-control input-sm" maxlength="255" aria-required="true" autofocus required>
                        ...
                        <span class="help-block"><span class="fa fa-check"></span> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"You will receive a link to reset your password."),$_smarty_tpl);?>
</span>
                        <?php }?>
                    </div>
                </div>
                ...
                <div class="group-btn">
                    <a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->generateUrlFunction(array('path'=>"/login"),$_smarty_tpl);?>
" class="btn btn-default pull-left"><i class="fa fa-chevron-left"></i> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Cancel"),$_smarty_tpl);?>
</a>
                    <button type="submit" class="btn btn-primary"><i class="fa fa-chevron-right"></i> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['intl'][0][0]->translate(array('l'=>"Send"),$_smarty_tpl);?>
</button>
                </div>
            </form>
