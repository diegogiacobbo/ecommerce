        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/home')) {
                ...
                if ($pathinfo === '/admin/home/stats') {
                    return array (  '_controller' => 'Thelia\\Controller\\Admin\\HomeController::loadStatsAjaxAction',  '_route' => 'admin.home.stats',);
                }
            ...
            if ($pathinfo === '/admin/ajax/thelia_news_feed') {
                return array (  '_controller' => 'Thelia\\Controller\\Admin\\AdminController::processTemplateAction',  'template' => 'ajax/thelia_news_feed',  'not-logged' => '1',  '_route' => 'admin.news-feed',);
            }
            ...
            if (0 === strpos($pathinfo, '/admin/export')) {
                ...
                if ($pathinfo === '/admin/export') {
                    return array (  '_controller' => 'Thelia\\Controller\\Admin\\ExportController::indexAction',  '_route' => 'export.list',);
                }

                if (0 === strpos($pathinfo, '/admin/export/position')) {
                    // export.position
                    if ($pathinfo === '/admin/export/position') {
                        return array (  '_controller' => 'Thelia\\Controller\\Admin\\ExportController::changePosition',  '_route' => 'export.position',);
                    }

                    // export.category.position
                    if ($pathinfo === '/admin/export/position/category') {
                        return array (  '_controller' => 'Thelia\\Controller\\Admin\\ExportController::changeCategoryPosition',  '_route' => 'export.category.position',);
                    }
                ...
                if (preg_match('#^/admin/export/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'export.mode')), array (  '_controller' => 'Thelia\\Controller\\Admin\\ExportController::export',));
                }
                not_exportmode:
                ...
                if (preg_match('#^/admin/export/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'export.view')), array (  '_controller' => 'Thelia\\Controller\\Admin\\ExportController::exportView',));
                }
                not_exportview:
            ...
            if (0 === strpos($pathinfo, '/admin/import')) {
                ...
                if ($pathinfo === '/admin/import') {
                    return array (  '_controller' => 'Thelia\\Controller\\Admin\\ImportController::indexAction',  '_route' => 'import.list',);
                }

                if (0 === strpos($pathinfo, '/admin/import/position')) {
                    // import.position
                    if ($pathinfo === '/admin/import/position') {
                        return array (  '_controller' => 'Thelia\\Controller\\Admin\\ImportController::changePosition',  '_route' => 'import.position',);
                    }

                    // import.category.position
                    if ($pathinfo === '/admin/import/position/category') {
                        return array (  '_controller' => 'Thelia\\Controller\\Admin\\ImportController::changeCategoryPosition',  '_route' => 'import.category.position',);
                    }
                ...
                if (preg_match('#^/admin/import/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'import.mode')), array (  '_controller' => 'Thelia\\Controller\\Admin\\ImportController::import',));
                }
                not_importmode:
                ...
                if (preg_match('#^/admin/import/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'import.view')), array (  '_controller' => 'Thelia\\Controller\\Admin\\ImportController::importView',));
                }
                not_importview:
